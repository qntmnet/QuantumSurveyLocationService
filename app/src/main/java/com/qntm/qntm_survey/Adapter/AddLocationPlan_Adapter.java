 ...
 */
public class AddLocationPlan_Adapter extends RecyclerView.Adapter {
    private List<AddLocationBean2> mDataSet = new ArrayList<>();
    private LayoutInflater mInflater;
    private Context mContext;
    private final ViewBinderHelper binderHelper = new ViewBinderHelper();

    private OnItemClickListenerData clickListener;
    public AddLocationPlan_Adapter(Context context, List<AddLocationBean2> dataSet) {
        mContext = context;
        mDataSet = dataSet;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder h, int position) {
        ...
        final AddLocationBean2 data = mDataSet.get(position);
        ...
        try {
            ...
            holder.img_planimage.setImageBitmap(bitmap);
        } catch (IOException e) {
